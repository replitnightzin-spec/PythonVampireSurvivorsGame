...
class Game:
    ...
    def load_images(self):
        ...
        folders = list(walk('S:\\Vscode\\aBUBU\\VampireSurvivorsPyGAME\\Vampire survivor\\images\\enemies'))[0][1]
        self.enemy_frames = {}
        for folder in folders:
            for folder_path, _, file_names in walk(join('S:\\Vscode\\aBUBU\\VampireSurvivorsPyGAME\\Vampire survivor\\images\\enemies', folder)):
